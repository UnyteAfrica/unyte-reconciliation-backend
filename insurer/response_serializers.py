...
class SuccessfulVerifyOTPSerializer(serializers.Serializer):
    id = (serializers.CharField(default=1, help_text='id of signed in user'),)
...
class SuccessfulViewInsurerSerializer(serializers.Serializer):
    ...
    email = serializers.EmailField(default='yourbusinessemail@gmail.com', help_text='Insurer email')
...
class AllAgentsSerializer(serializers.Serializer):
    ...
    first_name = serializers.CharField(default='first_name', help_text='Agent first name')
    last_name = serializers.CharField(default='last_name', help_text='Agent last name')
    email = serializers.EmailField(default='yourbusinessemail@gmail.com', help_text='Agent email')
...
class SuccessfulInsurerPoliciesSerializer(serializers.Serializer):
    agents = serializers.CharField(default='John Doe', help_text="agent's details [first_name + last_name]")
    policies_sold = InsurerAgentPoliciesSerializer(many=True)

    class Meta:
        fields = ['agents', 'policies_sold']
...
class SuccessfulInsurerAgentSignupCSVSerializer(serializers.Serializer):
    message = serializers.CharField(
        default='Successfully sent out invite links to <number_of_agents> agent(s)',
        help_text='success message after email has been sent to agent(s) email(s)',
    )
