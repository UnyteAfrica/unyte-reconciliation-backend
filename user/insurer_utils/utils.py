...
from insurer.utils import generate_otp, verify_otp, gen_absolute_url, gen_sign_up_url_for_agent
from django.conf import settings
from ..models import CustomUser
from datetime import datetime

from ..serializer import ViewInsurerDetailsSerializer, ViewInsurerProfileSerializer, CustomAgentSerializer
